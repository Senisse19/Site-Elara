...
const ElaraHero = () => {
  ...
  return <section id="inicio" className="min-h-screen flex items-center bg-background relative overflow-hidden">
    {/* Static Background Image - Optimized for Performance */}
    <img
      src="/hero-poster.png"
      alt="Hero background"
    ...
    {/* Dark Overlay for Text Readability and Texture Effect */}
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
        <div ref={heroRef} className={`lg:w-1/2 space-y-8 transition-all duration-700 flex flex-col items-center lg:items-start text-center lg:text-left ${heroVisible ? 'animate-fade-in' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className="space-y-4">
            <h1
              className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight break-words animate-fade-in text-foreground glow-text"
              translate="yes"
            >
              Coloque a Elara<br />
              para trabalhar<br />
            ...
            <p
              className="text-xl sm:text-2xl lg:text-3xl font-semibold break-words animate-fade-in bg-gradient-to-r from-primary via-blue-400 to-primary bg-clip-text text-transparent glow-text"
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex gap-2 animate-[slideInLeft_0.5s_ease-out_1.5s_backwards]">
                    <div className="bg-primary/10 rounded-2xl rounded-tl-sm px-4 py-2.5 max-w-[90%]">
                      <p className="text-sm text-foreground">Perfeito! Temos horários disponíves para esta semana. Qual especialidade você precisa? 🏥</p>
                    </div>
                  </div>
                </div>
