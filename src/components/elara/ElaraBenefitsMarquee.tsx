      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          <h2 className="text-4xl lg:text-5xl font-bold mb-6">
            ...
            <span className="text-primary bg-clip-text bg-gradient-to-r from-primary to-blue-400 glow-text">
        ...
        <div className="relative mb-16 overflow-hidden">
          <div className="flex animate-marquee hover:pause">
            ...
            {[...benefits, ...benefits].map((benefit, index) => (
              <div key={index} className="flex-shrink-0 w-96 px-3">
                <Card className="p-6 h-full bg-card-gradient border-primary/20 hover:shadow-glow transition-all duration-300 group">
                  ...
                  <h3 className="text-xl font-semibold text-foreground mb-3 glow-text">
                    {benefit.title}
                  </h3>
            ...
            <div className="max-w-4xl mx-auto text-center space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-8">
                <div className="text-center">
                  <div className="text-4xl font-bold text-primary mb-2 glow-text">70%</div>
                  <p className="text-sm text-muted-foreground">Redução no tempo médio de resposta no WhatsApp</p>
                </div>
                <div className="text-center">
                  <div className="text-4xl font-bold text-primary mb-2 glow-text">+180h/mês</div>
                  <p className="text-sm text-muted-foreground">Economizadas em tarefas repetitivas de atendimento</p>
                </div>
                <div className="text-center">
                  <div className="text-4xl font-bold text-primary mb-2 glow-text">98%</div>
...
export default ElaraBenefitsMarquee;
